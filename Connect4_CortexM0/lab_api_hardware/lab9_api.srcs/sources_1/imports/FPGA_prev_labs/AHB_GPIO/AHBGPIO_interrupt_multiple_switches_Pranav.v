...
//resume counter after stopped
//attempt for multiple switches
//made some mistakes with number of bits for the previous_switch
//module AHBGPIO(
//    input wire         HCLK,
//    input wire         HRESETn,
//    input wire  [31:0] HADDR,
...
//    // Interrupt signals
//    reg gpio_irq;
//    reg [15:0] previous_switch; //multiple switches
//    reg clear;
...
//        if (!HRESETn)
//            gpio_datain <= 16'h0000;
//        else if (((gpio_datain ^ previous_switch) != 16'h0000) && (gpio_dir == 16'h0000))
//            gpio_irq <= 1'b1;
//        else
//            gpio_datain <= GPIOOUT;
//    end
...
module AHBGPIO(
    ...
    // Interrupt flag register
    // Generates interrupt on rising edge of GPIOIN[4:0]
    always @(posedge HCLK or negedge HRESETn) begin
        if (!HRESETn) begin
            ...
            if (clear)
                gpio_irq <= 1'b0;
//            else if (((gpio_datain[4:0] & ~previous_switch[4:0]) != 5'b00000) &&
//                     (gpio_dir[4:0] == 5'b00000))
//                gpio_irq <= 1'b1;
